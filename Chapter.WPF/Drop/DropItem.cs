...
public sealed class DropItem : Freezable
{
    ...
    public static readonly DependencyProperty CommandProperty =
        DependencyProperty.Register("Command", typeof(ICommand), typeof(DropItem), new PropertyMetadata(null));

    /// <summary>
    ///     Identifies the DropType dependency property.
    /// </summary>
    public static readonly DependencyProperty DropTypeProperty =
        DependencyProperty.Register("DropType", typeof(DropType), typeof(DropItem), new PropertyMetadata(DropType.Files));

    /// <summary>
    ///     Identifies the DragDropEffect dependency property.
    /// </summary>
    public static readonly DependencyProperty DragDropEffectProperty =
        DependencyProperty.Register("DragDropEffect", typeof(DragDropEffects), typeof(DropItem), new PropertyMetadata(DragDropEffects.Copy));

    /// <summary>
    ///     Identifies the CommandParameter dependency property.
    /// </summary>
    public static readonly DependencyProperty CommandParameterProperty =
        DependencyProperty.Register("CommandParameter", typeof(object), typeof(DropItem), new PropertyMetadata(null));
